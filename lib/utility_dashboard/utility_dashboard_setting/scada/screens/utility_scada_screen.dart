...
import '../../utility_dashboard_setting_screens/base_setting_screen.dart';
...
import '../api/utility_scada_api.dart';
import '../models/utility_scada.dart';
import '../viewmodels/scada_view_model.dart';

class UtilityScadaScreen extends StatefulWidget {
  final bool isActive;
  final UtilityScadaApi api;

  const UtilityScadaScreen({
    super.key,
...
class _UtilityScadaScreenState extends State<UtilityScadaScreen> {
  ...
  @override
  void didUpdateWidget(covariant UtilityScadaScreen oldWidget) {
