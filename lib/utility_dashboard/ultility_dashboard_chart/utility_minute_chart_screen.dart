...
//     }
//
//     final firstBoxDevice = _safeSelectedBoxDevice(_catalog.boxDeviceIds);
//
//     if (firstBoxDevice != null) {
//       await _loadChartsForBox(firstBoxDevice, token: token);
//     }
//   }
//
...
//
//     final firstDevice = _safeSelectedBoxDevice(_catalog.boxDeviceIds);
//
//     if (firstDevice != null) {
//       await _loadChartsForBox(firstDevice);
//     }
//   }
//
...
//     });
//
//     if (selectedBoxDevice == null || selectedBoxDevice.trim().isEmpty) return;
...
//     if (tabs.isEmpty) return null;
//
//     if (_selectedBoxDeviceIndex < 0 || _selectedBoxDeviceIndex >= tabs.length) {
//       _selectedBoxDeviceIndex = 0;
//     }
//
...
//                   _onImportantChanged(selectedBoxDevice, value),
//               showImportantSwitch: selectedView == 'Minutes',
//               importantEnabled:
//                   selectedBoxDevice != null &&
//                   selectedBoxDevice.trim().isNotEmpty,
//               theme: theme,
//             ),
...
//               selectedBoxDeviceIndex: boxDeviceTabs.isEmpty
//                   ? 0
...
//                         ? const ['(no device)']
//                         : boxDeviceTabs,
//                     selectedIndex: boxDeviceTabs.isEmpty
//                         ? 0
  ...
  Future<void> _onImportantChanged(bool value) async {
    ...
    if (_selectedBoxDeviceIndex >= 0) {
      final selectedBoxDevice = _safeSelectedBoxDevice(
        context
            .read<ChartCatalogProvider>()
            .boxDeviceIds,
      );
      if (selectedBoxDevice != null && selectedBoxDevice
          .trim()
          .isNotEmpty) {
        await _loadChartsForBox(selectedBoxDevice);
      }
              ...
              itemBuilder: (context, index) {
                ...
                return RepaintBoundary(
                  child: ClipRRect(
                    ...
                    child: UtilityMinuteChartPanel(
                      key: ValueKey(
                        '${selectedFac}_${selectedCate}_${chart
                            .boxDeviceId}_${chart.plcAddress}',
                      ),
                      facId: selectedFac,
                      cate: selectedCate,
                      boxDeviceId: chart.boxDeviceId,
