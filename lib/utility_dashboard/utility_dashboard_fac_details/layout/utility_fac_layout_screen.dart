...
//
//   UtilityPeriodDashboard? _electricityDashboard;
//
...
//   void initState() {
//     super.initState();
//     _periodApi = context.read<UtilityPeriodApi>();
//     _loadFacility();
//   }
//
//   @override
...
//       // ==========================================================
//
//       unawaited(_loadElectricityRanking());
//     });
//   }
//
//   Future<void> _loadElectricityRanking() async {
//     if (_periodLoading) {
//       return;
//     }
//
...
//
//     try {
//       final result = await _periodApi.getDashboard(
//         facId: widget.facId,
//         type: 'ELECTRICITY',
//         period: 'MONTH',
//
//         // Test đúng API của bạn:
...
//
//       setState(() {
//         _electricityDashboard = result;
//         _periodLoading = false;
//         _periodError = null;
//       });
//     } catch (error, stackTrace) {
//       debugPrint('[ELECTRICITY PERIOD ERROR] $error');
//
...
//   }
//
//   Map<String, _PanelRankInfo> get _electricityTop5 {
//     final dashboard = _electricityDashboard;
//
//     if (dashboard == null || dashboard.byBox.isEmpty) {
//       return const {};
//     }
//
//     final sorted = [...dashboard.byBox]
//       ..removeWhere((item) => item.boxId.trim().isEmpty || item.total <= 0)
//       ..sort((a, b) => b.total.compareTo(a.total));
//
//     final result = <String, _PanelRankInfo>{};
//
//     final top5 = sorted.take(5).toList();
//
//     for (var index = 0; index < top5.length; index++) {
//       final item = top5[index];
//
//       final normalizedBoxId = _normalizeId(item.boxId);
//
//       result[normalizedBoxId] = _PanelRankInfo(
//         rank: index + 1,
...
//     final electricityTop5 = _electricityTop5;
...
//
//                 // ✅ THÊM
//                 electricityTop5: electricityTop5,
//
...
//                     ({required String boxDeviceId, required Offset position}) {
...
//   final Map<String, _PanelRankInfo> electricityTop5;
//
...
//   }
//
//   _PanelRankInfo? _rankOf(String boxDeviceId) {
...
//     }
//
//     for (final boxId in device.boxIds) {
//       final rank = widget.electricityTop5[_normalizeId(boxId)];
//
//       if (rank != null) {
//         return rank;
//       }
...
//     final device = _deviceOf(boxDeviceId);
//
//     final rankInfo = _rankOf(boxDeviceId);
//
//     return Positioned(
...
//             // TOP 5 ELECTRICITY
//             // ====================================================
//             if (!widget.editMode && rankInfo != null)
//               Positioned(
//                 top: -16,
//                 right: -8,
//
//                 child: _ElectricityRankBadge(info: rankInfo),
//               ),
//           ],
//         ),
//       ),
...
// }
//
// class _ElectricityRankBadge extends StatelessWidget {
//   final _PanelRankInfo info;
//
//   const _ElectricityRankBadge({required this.info});
//
//   @override
//   Widget build(BuildContext context) {
//     final color = _rankColor(info.rank);
//
//     return Container(
...
//       2 => const Color(0xFFFF7A1A),
//       3 => const Color(0xFFFFB400),
...
//   }
//
//   static String _formatElectricity(double value) {
//     if (value >= 1000) {
//       final number = value / 1000;
//
//       final text = number >= 10
...
//     final values =
//         boxIds.map((e) => e.trim()).where((e) => e.isNotEmpty).toList()
//           ..sort(_compareText);
//
//     if (values.isEmpty) {
//       return null;
...
//           // ========================================================
//
//           final boxId = _cleanText(box.boxId);
//
