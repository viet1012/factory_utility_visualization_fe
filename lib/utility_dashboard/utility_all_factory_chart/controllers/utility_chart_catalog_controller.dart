...
import '../models/chart_catalog_item.dart';
...
class UtilityChartCatalogController extends ChangeNotifier {
  final UtilityChartApi api;

  UtilityChartCatalogController(this.api);
  ...
  Future<void> loadCatalog({
    ...
    try {
      ...
      debugPrint('UtilityChartCatalogController.loadCatalog error: $error');
